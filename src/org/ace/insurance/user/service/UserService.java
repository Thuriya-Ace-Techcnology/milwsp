...
import org.ace.insurance.common.MessageId;
import org.ace.insurance.common.PasswordCodeHandler;
import org.ace.insurance.life.enums.TransactionType;
import org.ace.insurance.life.enums.WorkFlowType;
import org.ace.insurance.life.enums.WorkflowTask;
...
public class UserService extends BaseService implements IUserService {
	...
	public List<USR001> findUserByPermission(WorkflowTask workflowTask, WorkFlowType workFlowType, TransactionType transactionType, String branchId, String accessBranchId) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to user by permission : " + workflowTask + " : " + workFlowType, e);
		}
		return result;
	}
	...
	public List<USR001> findAllUser() throws SystemException {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to find all user", e);
		}
		return result;
	}
	...
	public User findUser(String userCode) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to find user by UserCode : " + userCode, e);
		}
		return user;
	}
	...
	public User findUserById(String id) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to find user by Id : " + id, e);
		}
		return user;
	}
	...
	public User authenticate(String usercode, String password, String loginBranchId) throws SystemException {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to login authenticate", e);
		}
		return user;
	}
