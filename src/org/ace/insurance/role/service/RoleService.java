...
public class RoleService extends BaseService implements IRoleService {
	...
	public Role addNewRole(Role role) {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to add a Role", e);
		}
		return role;
	}
	...
	public Role updateRole(Role role) {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to update role", e);
		}
		return role;
	}
	...
	public void deleteRole(Role role) {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to delete role", e);
		}
	}
	...
	public List<ROL001> findAllRole() {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to fine all Role", e);
		}
		return result;
	}
