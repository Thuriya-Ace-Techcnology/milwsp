...
@Entity
@Table(name = TableName.TEMP_RTA)

@TableGenerator(name = "RTATEMP_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", pkColumnValue = "RTATEMP_GEN", allocationSize = 10)
@Access(value = AccessType.FIELD)
public class TempRTA implements Serializable {
