...
public class TSP002 implements Serializable {
	...
	public TSP002(String id, String name, String code, String shortName, String district, String description, String shortNameMM) {
		this.id = id;
		this.name = name;
		this.code = code;
	...
	public TSP002(Township township) {
		...
		this.shortNameMM = township.getShortNameMM();
	}
