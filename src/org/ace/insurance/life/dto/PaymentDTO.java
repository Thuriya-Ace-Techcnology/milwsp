...
public class PaymentDTO implements ISorter {
	...
	private double moeaCommissoion;
	...
	public PaymentDTO(List<Payment> paymentList) {
		if (paymentList != null && !paymentList.isEmpty()) {
			...
			this.moeaCommissoion = tempPayment.getMoefCommission();
		}
	}
	...
	public double getTotalAmountForOutbound() {
		return getNetPremium() + getAgentCommission() + getTpaFee() + getServicesCharges().doubleValue();
	}
	public double getTotalAmount() {
		return getNetPremium() + getServicesCharges().doubleValue() + stampFees + administrationFees-agentCommission-moeaCommissoion;
	}
	...
	public double getMoeaCommissoion() {
		return moeaCommissoion;
	}

	public void setMoeaCommissoion(double moeaCommissoion) {
		this.moeaCommissoion = moeaCommissoion;
	}
