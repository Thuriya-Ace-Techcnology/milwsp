...
@Entity
@Table(name = TableName.POLICYINSUREDPERSONBENEFICIARIES)
...
public class PolicyInsuredPersonBeneficiaries implements Serializable {
	...
	public String getRelationshipNameMM() {
		if (relationship != null)
			return relationship.getNameMM();
		else
			return "-";
	}
	...
	public String getFullAddressAndPhoneNo() {
		return phone == null ? residentAddress.getResidentAddress() : residentAddress.getResidentAddress() +" "+ phone;
	}
	...
	public String getBeneIdNo(){
		if(IdType.NRCNO.equals(idType)) {
			return idNoMM;
		}else if(IdType.STILL_APPLYING.equals(idType)) {
			return "-";			
		}else {
			return idNo;
		}
	...
	public String getAgeMM() {
		return  AbstractMynNumConvertor.getAmountWithMyanmar(String.valueOf(age));
	}
	
	public String getDobMM() {
		return  AbstractMynNumConvertor.getDateWithMyanmar(Utils.formattedDate(dateOfBirth));
	}
	
	public String getPercentageMM() {
		return  AbstractMynNumConvertor.getAmountWithMyanmar(String.valueOf((int)percentage));
	}
