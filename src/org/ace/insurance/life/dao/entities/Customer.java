...
import org.ace.insurance.common.Industry;
...
import org.ace.insurance.common.Religion;
import org.ace.insurance.common.ResidentAddress;
import org.ace.insurance.common.TableName;
import org.ace.insurance.common.UserRecorder;
import org.ace.insurance.life.OfficeAddress;
import org.ace.insurance.life.enums.CustomerStatus;
import org.ace.insurance.life.enums.IdConditionTypeMM;
import org.ace.insurance.life.enums.PassportType;
...
public class Customer implements Serializable {
	...
	public void setFullIdNo() {
		if (idType.equals(IdType.NRCNO)) {
			fullIdNo = stateCode + "/" + townshipCodeENG + "(" + idConditionType + ")" + idNo;
	...
	public void setFullIdNoMM() {	
		if(IdType.NRCNO.equals(idType)){
			idNoMM = AbstractMynNumConvertor.getAmountWithMyanmar(idNo);
			stateCodeMM = AbstractMynNumConvertor.getAmountWithMyanmar(stateCode);
			idConditionTypeMM = IdConditionTypeMM.valueOf(idConditionType).getLabel();
			fullIdNoMM = stateCodeMM+"/"+townshipCodeMM+"("+idConditionTypeMM+")"+idNoMM;			
		}else {
			fullIdNoMM = null;
		}
