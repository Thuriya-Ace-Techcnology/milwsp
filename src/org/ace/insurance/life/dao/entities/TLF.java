...
public class TLF implements Serializable {
	...
	/*TLF For PolicyCancellation*/
	public TLF(TLF tlfData) {
		this.homeAmount = Utils.nagate(tlfData.getHomeAmount());
		this.localAmount =  Utils.nagate(tlfData.getLocalAmount());
		this.rate = tlfData.getRate();
		this.currencyId = tlfData.getCurrencyId();
		this.chequeNo = tlfData.getChequeNo();
		this.tranTypeId = tlfData.getTranTypeId();
		this.enoNo = tlfData.getEnoNo();
		this.referenceNo = tlfData.getReferenceNo();
		this.bankId = tlfData.getBankId();
		this.customerId = tlfData.getCustomerId();
		this.branchId = tlfData.getBankId();
		this.ccoaId = tlfData.getCcoaId();
		this.narration = tlfData.getNarration();
		this.referenceType = tlfData.getReferenceType();
		this.tlfNo = tlfData.getTlfNo();
		this.branchId=tlfData.getBranchId();
		this.paid=tlfData.isPaid();
