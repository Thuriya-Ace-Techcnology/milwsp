...
public class MenuService implements IMenuService {
	...
	public void addNewMainMenu(MainMenu mainMenu) throws SystemException {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to add a new MainMenu", e);
		}
	}
	...
	public void updateMainMenu(MainMenu mainMenu) throws SystemException {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to update a MainMenu", e);
		}
	}
	...
	public void deleteMainMenu(MainMenu mainMenu) throws SystemException {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to delete a MainMenu", e);
		}
	}
	...
	public void addNewSubMenu(SubMenu subMenu) throws SystemException {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to add a new SubMenu", e);
		}
	}
	...
	public void updateSubMenu(SubMenu subMenu) throws SystemException {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to update a SubMenu", e);
		}
	}
	...
	public void deleteSubMenu(SubMenu subMenu) throws SystemException {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to delete a SubMenu", e);
		}
	}
	...
	public void addNewMenuItem(MenuItem menuItem) throws SystemException {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to add a new MenuItem", e);
		}
	}
	...
	public void updateMenuItem(MenuItem menuItem) throws SystemException {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to update a MenuItem", e);
		}
	}
	...
	public void deleteMenuItem(MenuItem menuItem) throws SystemException {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to delete a MenuItem", e);
		}
	}
	...
	public List<MainMenu> findAllMainMenu() throws SystemException {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to find all of MainMenu)", e);
		}
		return result;
	}
	...
	public MainMenu findMainMenuById(String id) throws SystemException {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to find a MainMenu (ID : " + id + ")", e);
		}
		return result;
	}
